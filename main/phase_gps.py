...
class Gps_phase():
    def __init__(self, motor=class_motor.Motor(), gps=class_gps.Gps(), mag=class_geomag.GeoMagnetic(calibrated=True, rads=[27, 15.4, 33.4],aves=[-105.6, 13.4, -43.9])):#, subthread=subthread.Subthread()):
